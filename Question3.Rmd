...
For this section we will be creating a subset of the data for US temperatures after 1990 and anserwing multiple questions subset of data we create.

First we will create a Farhenheit column in the dataframe.
```{r}
...
head(df_UStemp)
```
Next we will take the new column and Calcualte the average land temperture by year and plot it with temperature on the y axis and years on the X axis.
...
Next we will divide the Temperature averages into two year increaments. ie 1990-1991, 1992-1993, 1994-1995, etc.
